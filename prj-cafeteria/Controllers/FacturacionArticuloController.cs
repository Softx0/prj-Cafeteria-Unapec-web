...
namespace prj_cafeteria.Controllers
{
    public class FacturacionArticuloController : Controller
    {
        ...
        // GET: FacturacionArticulo
        public ActionResult Index()
        {
            var fACTURACION_ARTICULOS = db.FACTURACION_ARTICULOS.Include(f => f.Articulos).Include(f => f.EMPLEADO).Include(f => f.USUARIO);
            return View(fACTURACION_ARTICULOS.ToList());
        }

        // GET: FacturacionArticulo/Details/5
        ...
        // GET: FacturacionArticulo/Create
        ...
        // POST: FacturacionArticulo/Create
        ...
        public ActionResult Create([Bind(Include = "NoFactura,Unidades,IdEmpleado,IdArticulo,IdUsuario,FechaVenta,MontoArticulo,Comentario,Estado")] FACTURACION_ARTICULOS fACTURACION_ARTICULOS)
        {
            ...
            ViewBag.IdArticulo = new SelectList(db.Articulos, "ID", "DESCRIPCION", fACTURACION_ARTICULOS.IdArticulo);
        ...
        // GET: FacturacionArticulo/Edit/5
        ...
        // POST: FacturacionArticulo/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: FacturacionArticulo/Delete/5
        ...
        // POST: FacturacionArticulo/Delete/5
